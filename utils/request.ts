...
const requests = {
    ...
    //fetchNetflixOriginals:"https://api.themoviedb.org/3/discover/tv?api_key=25ef82cbb3ce4fe15a52d9899117b1fb&language=en-CA&page=1&with_networks=213",
    fetchNetflixOriginals: `${BASE_URL}/discover/tv?api_key=${API_KEY}&language=en-CA&page=1&with_networks=213`,
